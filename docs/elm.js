...
var $author$project$Route$Node = F2(
	function (a, b) {
		return {$: 'Node', a: a, b: b};
	});
	...
	A2(
		...
		A4(
			...
			$elm$json$Json$Decode$maybe(
				A2($elm$json$Json$Decode$field, 'scientificName', $elm$json$Json$Decode$string)),
			$elm$json$Json$Decode$maybe(
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'UrlChanged':
				var url = msg.a;
				return A2(
					$author$project$Main$loadFromUrl,
					url,
					_Utils_update(
						model,
						{url: url}));
